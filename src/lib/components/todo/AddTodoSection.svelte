...
<section class="flex justify-between items-center">
  ...
  <button class="group flex items-center rounded-md border-cream-four bg-green-one px-3 sm:px-6 py-3 text-xs sm:text-lg font-semibold text-gray-five outline-2 outline-offset-2 outline-green-one hover:text-green-five focus-visible:text-green-five focus-visible:outline-green-five" type="button" on:click={addTodo}>
    Add Task
    <svg
